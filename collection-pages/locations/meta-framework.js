...
const constructedVariables = {
    locationCityAndStateAbbr: `${pageData.locationCity}, ${pageData.locationStateAbbr}`,
};

const secondaryVariables = {
    pageTitle: `Tree Cutting Services in ${constructedVariables.locationCityAndStateAbbr} | Precision Cutting Services`,
    pageSummary: `PSC had been serving the tree service needs of ${constructedVariables.locationCityAndStateAbbr} for decades. Call us today for a free estimate!`,
};
...
setMetaTag('description', secondaryVariables.pageSummary);
...
setMetaTag('og:title', secondaryVariables.pageTitle, true);
setMetaTag('og:description', secondaryVariables.pageSummary, true);
...
setMetaTag('og:image:alt', `${secondaryVariables.pageTitle}`, true);

// Twitter
setMetaTag('twitter:card', 'summary_large_image');
setMetaTag('twitter:title', secondaryVariables.pageTitle);
setMetaTag('twitter:description', secondaryVariables.pageSummary);
setMetaTag('twitter:image', pageData.ogImagePath);
setMetaTag('twitter:image:alt', `${secondaryVariables.pageTitle}`);
